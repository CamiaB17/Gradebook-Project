...
##Files
FileDescriptionschema.sqlCreates the gradebook database and all 6 tablesseed.sqlInserts sample data (3 courses, 8 students, 26 assignments)gradebook.pyPython script that runs all tasks and prints outputREADME.mdThis file
